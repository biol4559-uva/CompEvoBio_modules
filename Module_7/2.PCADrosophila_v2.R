...
pca.dt <- data.table(PC1=pca.snps$x[,1], PC2=pca.snps$x[,2], sampleId=dimnames(pca.snps$x)[[1]])
pca.dt[,trt:=tstrsplit(sampleId, "_")[[3]]]
pca.dt <- merge(pca.dt, samps, by="sampleId")
