...
3. Once your repository is created, click on it. Then click on "Manage Access". You might be asked for your GitHub password again. Click "Add People" and type in Alan's id ("alanbergland") and Sihui's id (SihuiHuangfayth). Give us "Write" privileges.
