...
### libraries
  .libPaths(c("/scratch/aob2x/coverage/biol4559-aob2x/packages_temp", .libPaths())); .libPaths()
  ...
  library(patchwork)
  library(foreach)
  #install.packages("foreach", lib="/scratch/aob2x/coverage/biol4559-aob2x/packages_temp")
